...
import (
	"github.com/teltech95/go-react-auth/backend/datasource/mysql/users_db"
...
func (user *User) Save() *errors.RestErr {
	...
	if err != nil {
		return errors.NewIternalServerError("database error")
	}
	defer stmt.Close()
...
func (user *User) GetByEmail() *errors.RestErr {
	...
	if err != nil {
		return errors.NewIternalServerError("invalid email")
	}
